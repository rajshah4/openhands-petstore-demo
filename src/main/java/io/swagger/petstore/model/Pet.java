...
public class Pet {
    ...
    @XmlElement(name = "adoptionFee")
    @Schema(description = "adoption fee for the pet, in whole currency units", example = "75")
    public Integer getAdoptionFee() {
        return adoptionFee;
    }

    public void setAdoptionFee(final Integer adoptionFee) {
